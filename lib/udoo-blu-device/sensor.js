...
Sensor.prototype.forcePeriodToZero = function (udooblu, serviceUuid, callback) {
    udooblu.writeUInt16LECharacteristic(serviceUuid, SensorNotificatioPeriodUUID, 0, callback);
};
